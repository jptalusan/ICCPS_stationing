...
class Simulator:
    ...
    def run_simulation(self):
        ...
        while len(self.event_queue) > 0:
            ...
            if len(self.event_queue) > 0:
                new_events = self.environment_model.update(self.state, self.event_queue[0], self.passenger_arrival_distribution)
    ...
    def decide_and_take_actions_baseline(self, update_event, _valid_actions):
        ...
        elif update_event.event_type == EventType.VEHICLE_ARRIVE_AT_STOP or \
        ...
        if update_event and \
            ...
            if bus_id and self.state.buses[bus_id].type == BusType.OVERLOAD:
                pass
                    ...
                    ((self.state.time - self.state.buses[bus_id].last_decision_epoch) < dt.timedelta(
                        minutes=DECISION_INTERVAL)) and \
