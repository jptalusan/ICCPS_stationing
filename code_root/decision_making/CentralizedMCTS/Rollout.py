...
class BareMinimumRollout:
    ...
    #
    #             travel_time = self.get_stop_to_stop_travel_time(current_stop,
    #                                                             reallocation_stop)
    #
    #             distance_to_next_stop = self.get_stop_to_stop_distance(current_stop,
    #                                                                    reallocation_stop)
    #             time_to_state_change = state.time + dt.timedelta(seconds=travel_time)
    ...
    #     return dd / 1000
    #
    # def get_stop_to_stop_travel_time(self, current_stop, next_stop):
    #     tt = -1
    #
    #     if (current_stop is not None) and (current_stop == next_stop):
    #         return 0
