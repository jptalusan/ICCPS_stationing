...
if __name__ == "__main__":
    ...
    tdf['key_pair'] = list(zip(tdf.route_id_direction, tdf.block_abbr, tdf.stop_sequence, tdf.stop_id_original, tdf.time, tdf.IsWeekend))
    tdf = tdf.set_index('key_pair')
    tdf = tdf.drop(['route_id_direction', 'block_abbr', 'stop_sequence', 'stop_id_original', 'time', 'IsWeekend'], axis=1).to_dict('index')
